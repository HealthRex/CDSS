...
To do this, we use the following script (the -x flag denotes which features we don't want to transform). In the output folder, two files: <b>avg_stddev.hdf5</b> and <b>freq_y.hdf5</b> will be generated.
