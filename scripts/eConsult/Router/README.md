...
1. Adds the project root to sys.path and imports Config from utils.config.
2. Loads:
...
``` 
4. It expects the model to return JSON of the form:
```text
{
...
```
5. It parses that JSON, trims/pads the lists, and returns:
