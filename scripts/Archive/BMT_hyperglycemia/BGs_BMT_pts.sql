...
SELECT Lab.rit_uid, Lab.pat_enc_csn_id_coded, Lab.lab_name, Lab.base_name, Lab.ord_num_value, Lab.taken_time_jittered, Lab.order_id_coded FROM starr_datalake2018.lab_result AS Lab
...
Order by Lab.pat_enc_csn_id_coded, Lab.order_id_coded, Lab.taken_time_jittered
