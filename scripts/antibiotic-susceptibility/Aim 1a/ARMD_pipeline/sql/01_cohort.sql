...
#########################################################################################################################
  ...
  --         SELECT DISTINCT ensures one row per (culture, organism, antibiotic, canonical susceptibility) — a separate
  --         DISTINCT lives inside positive_culture_details to dedupe raw culture_sensitivity rows; this outer DISTINCT
  --         catches the edge case where multiple raw suscept values (e.g. "Resistant" and "Non Susceptible") collapse
  --         to the same canonical value in the CASE statement below.
#########################################################################################################################
