...
##################
CREATE OR REPLACE TABLE `som-nero-phi-jonc101.antimicrobial_stewardship.microbiology_culture_prior_infecting_organism_augmented` AS (
...
TIMESTAMP_DIFF(c.order_time_jittered_utc, past_cs.prior_infecting_organism_recorded_time, DAY) as prior_infecting_organism_days_to_culture,
