...
CREATE OR REPLACE TABLE `som-nero-phi-jonc101.antimicrobial_stewardship.microbiology_cultures_antibiotic_subtype_exposure_peds` AS
WITH subtype_exposure AS (
    ...
    FROM
        `som-nero-phi-jonc101.antimicrobial_stewardship.microbiology_cultures_medication_exposure_peds` AS mcp
    LEFT JOIN
