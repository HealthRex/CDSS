-- For each abx order ordered within 2 weeks after er_admit - get whether it was started and abx_stop_time
...
FROM `mining-clinical-decisions.abx.abx_orders_within_2_weeks`  abx
