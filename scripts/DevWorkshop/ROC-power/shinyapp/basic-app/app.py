...
app_ui = ui.page_fixed(ui.panel_title("Sample Size for Comparing Models' Area Under the ROC Curve:", "Sample Size for Comparing AUROCs"),  
    ...
    ui.row(
        ui.column(
            ...
            ui.input_slider("X_mean1", label="- Model A: Mean parameter", value=.7, min=1e-3, max=1-1e-3),
            ui.input_slider("X_var1", label="- Model A: Variance parameter", value=.9, min=1e-3, max=1-1e-3),
            ui.input_slider("Y_mean1", label="- Model B: Mean parameter", value=.6, min=1e-3, max=1-1e-3),
            ui.input_slider("Y_var1", label="- Model B: Variance parameter", value=.9, min=1e-3, max=1-1e-3),
        ...
        ui.column(
            ...
            ui.input_slider("X_var2", label="- Model A: Variance parameter", value=.9, min=1e-3, max=1-1e-3),
            ui.input_slider("Y_mean2", label="- Model B: Mean parameter", value=.4, min=1e-3, max=1-1e-3),
            ui.input_slider("Y_var2", label="- Model B: Variance parameter", value=.9, min=1e-3, max=1-1e-3),
