...
app_ui = ui.page_fluid(
    ...
    ui.br(),
    ui.h4("- Inputs"),
    ui.input_slider("auroc", label=ui.p(ui.strong(ui.div({"style": ""},"Anticipated AUROC in the evaluation population")), ui.em("How well do we expect the model to perform on the test set?")), value=.81, step=.01, min=.5, max=1-1e-2, width="600px"),
    ui.input_slider("prev", label=ui.p(ui.strong(ui.div({"style": ""},"Prevalence in the evaluation population")), ui.em("What is the anticipated proportion of events in the test set?")), value=.20, step=.01, min=1e-2, max=1-1e-2, width="600px"),
