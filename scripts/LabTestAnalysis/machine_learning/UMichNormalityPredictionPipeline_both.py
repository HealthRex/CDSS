...
from extraction.LabNormalityMatrix import LabNormalityMatrix as LabNormalityMatrix
if LocalEnv.DATASET_SOURCE_NAME == 'UMich':
    # from extraction.UMichNormalityMatrix import UMichNormalityMatrix as LabNormalityMatrix
...
class LabNormalityPredictionPipeline(SupervisedLearningPipeline):
    ...
    def _build_processed_feature_matrix(self):
        ...
        if LocalEnv.DATASET_SOURCE_NAME == 'STRIDE':
            features_to_remove += ['RaceWhiteHispanicLatino.preTimeDays',
