...
FINAL_TABLE_SCHEMA = [bigquery.SchemaField('ANON_ID', 'STRING', 'REQUIRED', None, ()),
                      ...
                      bigquery.SchemaField('BILLING_PROV_MAP_ID', 'DATE', 'NULLABLE', None, ()),
                      bigquery.SchemaField('REFERRING_PROV_MAP_ID', 'DATETIME', 'NULLABLE', None, ()),
...
UPLOAD_TABLE_SCHEMA = [bigquery.SchemaField('ANON_ID', 'STRING', 'REQUIRED', None, ()),
                      ...
                      bigquery.SchemaField('CODE', 'STRING', 'NULLABLE', None, ()),
                      bigquery.SchemaField('DESCRIPTION', 'INT64', 'NULLABLE', None, ()),
                      bigquery.SchemaField('ORDERING_DATE_JITTERED', 'STRING', 'NULLABLE', None, ()),
                      bigquery.SchemaField('PROC_START_TIME_JITTERED', 'DATETIME', 'NULLABLE', None, ()),
                      bigquery.SchemaField('PROC_END_TIME_JITTERED', 'DATETIME', 'NULLABLE', None, ()),
                      bigquery.SchemaField('RPT_PRELIM_DTTM_JITTERED', 'DATETIME', 'NULLABLE', None, ()),
                      bigquery.SchemaField('RPT_FINAL_DTTM_JITTERED', 'DATETIME', 'NULLABLE', None, ()),
