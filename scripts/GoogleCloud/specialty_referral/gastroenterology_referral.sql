...
# resulting table: z2_subaim_referral_table_cardio 
...
# Create A subcohort study on Gastroenterology 

# resulting table: z2_subaim_referral_table_gastro

/*
    select *
    from  `datalake_47618.z_subaim_referral_table`
    where description like "REFERRAL_TO_GASTROENTEROLOGY"
    and appt_time_jittered > '2014'
*/
...
# Create a Clinical Department Timeline for Gastroenterology Referral Patients 

# resulting table: z3_subaim_referral_table_gastro
...
WHERE jc_uid in 
  (
  select distinct(jc_uid) jc_uid 
  from `datalake_47618.z2_subaim_referral_table_gastro` 
)
*/
...
/*
      SELECT
        ...
        b.date, b.visit_type, b.jc_uid, b.pat_enc_csn_id_coded, b.department_id
      FROM `datalake_47618.order_proc` as a
      INNER JOIN `datalake_47618.z3_subaim_referral_table_gastro` as b
      ON a.pat_enc_csn_id_coded = b.pat_enc_csn_id_coded
      where date > '2014'
*/
...
/*
select * 
from `datalake_47618.z4_subaim_referral_table_gastro`
where visit_type like "NEW PATIENT%"
 */
