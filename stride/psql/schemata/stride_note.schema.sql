...
-- Clean Files:
--  * stride_clinical_notes_year_1.csv.gz
--  * stride_clinical_notes_year_2.csv.gz
--  * stride_clinical_notes_year_3.csv.gz
--  * stride_clinical_notes_year_4.csv.gz
--  * stride_clinical_notes_year_5.csv.gz
--  * stride_clinical_notes_year_6.csv.gz
--  * stride_clinical_notes_year_7.csv.gz
--  * stride_clinical_notes_year_8.csv.gz
-- CSV Fields:
