...
ALTER TABLE order_result_stat ADD COLUMN IF NOT EXISTS max_result_flag TEXT;
ALTER TABLE order_result_stat ADD COLUMN IF NOT EXISTS max_result_in_range TEXT;
