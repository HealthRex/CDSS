-- Patient Notes
CREATE TABLE IF NOT EXISTS sim_note
(
	...
	CONSTRAINT sim_note_pkey PRIMARY KEY (sim_note_id),
	CONSTRAINT sim_note_state_fkey FOREIGN KEY (sim_state_id) REFERENCES sim_state(sim_state_id),
	CONSTRAINT sim_note_note_type_fkey FOREIGN KEY (note_type_id) REFERENCES sim_note_type(sim_note_type_id),
	CONSTRAINT sim_note_author_type_fkey FOREIGN KEY (author_type_id) REFERENCES sim_note_type(sim_note_type_id),
	CONSTRAINT sim_note_service_type_fkey FOREIGN KEY (service_type_id) REFERENCES sim_note_type(sim_note_type_id)
);
...
CREATE INDEX IF NOT EXISTS index_sim_note_state ON sim_note(sim_state_id,relative_state_time);
