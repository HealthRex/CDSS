...
CREATE TABLE IF NOT EXISTS sim_patient_state
(
	...
	CONSTRAINT sim_patient_state_pkey PRIMARY KEY (sim_patient_state_id),
	CONSTRAINT sim_patient_state_patient_fkey FOREIGN KEY (sim_patient_id) REFERENCES sim_patient(sim_patient_id),
	CONSTRAINT sim_patient_state_state_fkey FOREIGN KEY (sim_state_id) REFERENCES sim_state(sim_state_id)
);
...
CREATE INDEX IF NOT EXISTS index_sim_patient_state_patient ON sim_patient_state(sim_patient_id,relative_time_start,relative_time_end);
CREATE INDEX IF NOT EXISTS index_sim_patient_state_state ON sim_patient_state(sim_state_id);
