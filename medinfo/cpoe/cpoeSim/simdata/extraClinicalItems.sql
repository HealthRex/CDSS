...
insert into clinical_item(clinical_item_id, clinical_item_category_id, external_id, name, description, default_recommend, analysis_status, item_count, patient_count, encounter_count)
  values (-100, 12, null, 'DCCV', 'Direct Current Cardioversion', 1, 1, 200, 200, 200);
