...
class FeatureMatrix:
    ...
    def _add_time_features(self, index_time_col=None):
        ...
        self._factory.addClinicalItemFeaturesByCategory([ADMIT_DX_CATEGORY_ID], \
            dayBins=[], label='AdmitDxDate', features='pre', is_Michigan_data=True, tableName='encounters')
    ...
    def _add_lifespan_features(self):
        ...
        self._factory.addClinicalItemFeatures(['Birth'], dayBins=[], features="pre", is_Michigan_data=True,
                                              clinicalItemType=None, clinicalItemTime='Birth', tableName='pt_info')
        # self._factory.addClinicalItemFeatures(['Death'], clinicalItemTime='Death', dayBins=[], features="post", is_Michigan_data=True)
