-- Table: backup_link_patient_item
-- Description: Backup table for links overridden when merging clinical items
--              that seem related, but don't want to destroy data completely.
